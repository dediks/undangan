                ...
                <div className="mt-16 md:mt-0 lg:min-h-[800px] md:flex md:justify-between md:items-center 2xl:px-48">
                    ...
                    <div className="">
                        <motion.img
                            ...
                            variants={imageVariants}
                            viewport={{ once: true }}
                            className="mx-auto mt-4 border-2 md:border-4 shadow-white shadow-2xl rounded-sm border-gray-300 bg-gray-200 w-6/7 md:w-64 md:hover:scale-125 transition duration-500 cursor-pointer aspect-[3/4] md:aspect-[9/16] object-cover object-center"
