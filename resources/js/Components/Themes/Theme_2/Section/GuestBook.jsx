    ...
    return (
        <div className="p-4 mt-10 md:px-28">
            <section className="p-4 mt-10">
                ...
                <div className="mt-10 border border-gray-100 p-4 bg-gray-50 ">
                    ...
                    {tamu && (
                        ...
                        >
                            ...
                            <div className="w-full md:flex md:justify-center">
                                <button className="mt-5 mx-auto flex space-x-2 md:px-6 hover:bg-gray-800/90 hover:outline-1 hover:outline-gray-100 items-center px-4 py-2 bg-gray-800 font-bold text-gray-100">
                                    <BsSendFill />
                                    <span>Kirim</span>
                                </button>
                            </div>
                ...
                <div className="w-full flex flex-col space-y-5 max-h-[400px] overflow-y-auto border-gray-100 border-4 p-4 rounded">
