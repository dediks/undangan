...
const Quotes = ({ data, attributes, isPreview = false }) => {
    ...
    return (
        ...
        >
            ...
            <div className="mt-10 w-full relative lg:px-24 lg:pb-32 lg:pt-10">
                <div ref={imageRef}>
                    <motion.div
                        initial={{
                            y: -30,
                        ...
                        className="w-full h-52 md:h-full aspect-video relative p-0.5"
                    >
                        <img
                ...
                >
                    <motion.div
                        ...
                        className="shadow-xl h-full w-6/12 aspect-video"
                    >
                        <img
                            className="w-full md:p-1 h-full object-cover object-center"
                            height={200}
                    ...
                    <motion.div
                        ...
                        className="shadow-xl w-6/12 h-full aspect-video"
                    >
                        <img
                            className="w-full md:p-1 h-full object-cover object-center"
                            height={200}
